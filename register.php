<html>
  ...
  <?php
	...
	{			
			...
			{
				$select="SELECT user_id FROM my_guest WHERE user_id=".$_POST['username'];    //检测用户名是否已存在
				...
				else
				{
					...
					$insert="INSERT INTO my_guest (user_id,user_password) VALUES ('".$_POST['username']."','".$new_pass."')";
